...
const EVENT_TYPES = new Set<string>([
  ...
  "BOOKING_INTENT_WECHAT","BOOKING_INTENT_KAKAO","SESSION_START","SESSION_END","ERROR",
  "CHAT_OPEN","CHAT_MESSAGE","CHAT_FEEDBACK","CHAT_TRIP_CLICK",
  "CHAT_ITINERARY_SAVE","CHAT_ITINERARY_SHARE",
  "PLAN_VIEW","PLAN_CREATE","PLAN_TRIP_ADD","PLAN_TRIP_REMOVE",
  "PLAN_SHARE","PLAN_INVITE","PLAN_CONTACT","PLAN_EMAIL_LINK",
  "ARK_AI_SLOT_FILLED","ARK_AI_SLOT_SKIPPED","ARK_AI_PLAN_GENERATED",
  "ARK_AI_PLAN_SAVED","ARK_AI_TEMPLATE_SELECTED","ARK_AI_BUDGET_BLOCKED",
  "ARK_AI_PERSONALIZED",
]);
