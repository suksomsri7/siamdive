...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Maldives Liveaboards", href: "/backoffice/trips/liveaboard-maldives", icon: "🇲🇻" },
      { label: "Red Sea Liveaboards", href: "/backoffice/trips/liveaboard-red-sea", icon: "🇪🇬" },
      { label: "Indonesia Liveaboards", href: "/backoffice/trips/liveaboard-indonesia", icon: "🇮🇩" },
      { label: "Palau Liveaboards", href: "/backoffice/trips/liveaboard-palau", icon: "🇵🇼" },
      { label: "Philippines Liveaboards", href: "/backoffice/trips/liveaboard-philippines", icon: "🇵🇭" },
