...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Maldives Liveaboards", href: "/backoffice/trips/liveaboard?country=maldives", icon: "🇲🇻" },
      { label: "Red Sea Liveaboards", href: "/backoffice/trips/liveaboard?country=red-sea", icon: "🇪🇬" },
      { label: "Indonesia Liveaboards", href: "/backoffice/trips/liveaboard?country=indonesia", icon: "🇮🇩" },
      { label: "Palau Liveaboards", href: "/backoffice/trips/liveaboard?country=palau", icon: "🇵🇼" },
      { label: "Philippines Liveaboards", href: "/backoffice/trips/liveaboard?country=philippines", icon: "🇵🇭" },
