...
const TITLES: Record<string, string> = {
  ...
  ja: "近くのツアー",
  ko: "근처 투어",
  de: "Trips in deiner Nähe",
  fr: "Voyages près de chez vous",
  ru: "Туры рядом с вами",
};

const SECTION_ID = "nearby-trips";

export default function NearbyTripsRow({
  lang,
  onSelect,
  onRecentUpdate,
}: {
  ...
  useEffect(() => {
    fetch(`/api/public/nearby-trips?lang=${encodeURIComponent(lang)}`)
      .then((r) => (r.ok ? r.json() : []))
      .then((data: NearbyTrip[]) => {
