...
const L = {
  ...
  ja: {
    ...
    needs: "備考",
    diverCount: "ダイビング",
    nonDiverCount: "ダイビングなし",
    groupTotal: "グループ合計",
    bookIntro: "こんにちは。以下のツアーを予約したいです",
    logisticsHdr: "詳細情報：",
    priceFrom: "から",
    perPerson: " バーツ/人",
    emailLabel: "メール",
  ...
  ko: {
    fromHotel: "픽업 장소",
    transferYes: "공항 픽업/샌딩",
    rent: "장비 대여",
    needs: "비고",
    diverCount: "다이빙",
    nonDiverCount: "다이빙 안 함",
    groupTotal: "그룹 합계",
    bookIntro: "안녕하세요. 다음 투어를 예약하고 싶습니다",
    logisticsHdr: "추가 정보:",
    priceFrom: "부터",
    perPerson: " 바트/인",
    emailLabel: "이메일",
  ...
  de: {
    fromHotel: "Abholung bei",
    transferYes: "Flughafentransfer",
    rent: "Ausrüstung mieten",
    needs: "Anmerkungen",
    diverCount: "Taucher",
    nonDiverCount: "Nichttaucher",
    groupTotal: "Gruppensumme",
    bookIntro: "Hallo, ich möchte die folgenden Touren buchen",
    logisticsHdr: "Weitere Details:",
    priceFrom: "ab",
    perPerson: " THB/Person",
    emailLabel: "E-Mail",
  },
  fr: {
    fromHotel: "Prise en charge à",
    transferYes: "Transfert aéroport",
    rent: "Location d'équipement",
    needs: "Remarques",
    diverCount: "plongeurs",
    nonDiverCount: "non-plongeurs",
    groupTotal: "Total du groupe",
    bookIntro: "Bonjour, je souhaite réserver les excursions suivantes",
    logisticsHdr: "Détails supplémentaires :",
    priceFrom: "à partir de",
    perPerson: " THB/personne",
    emailLabel: "E-mail",
  },
  ru: {
    fromHotel: "Место встречи",
    transferYes: "Трансфер из аэропорта",
    rent: "Аренда снаряжения",
    needs: "Примечания",
    diverCount: "дайверы",
    nonDiverCount: "без дайвинга",
    groupTotal: "Всего по группе",
    bookIntro: "Здравствуйте, хочу забронировать следующие туры",
    logisticsHdr: "Дополнительные сведения:",
    priceFrom: "от",
    perPerson: " бат/чел.",
    emailLabel: "Эл. почта",
  },
